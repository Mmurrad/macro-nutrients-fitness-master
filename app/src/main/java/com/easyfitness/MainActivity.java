...
public class MainActivity extends AppCompatActivity {
    ...
    private CircularImageView roundProfile = null, waterConsump = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        waterConsump = top_toolbar.findViewById(R.id.imageWater);

        waterConsump.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, com.water.MainWindow.MainActivity.class));
            }
        });
