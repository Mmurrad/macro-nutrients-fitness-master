...
import com.water.Model.DateLog;
import com.water.Model.TimeLog;
...
public class ChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BarData barData = new BarData((IBarDataSet) getXAxisValues(), barDataSet);
        ...
        BarData weekBarData = new BarData((IBarDataSet) getXAxisWeekValues(), weekBarDataSet);
        ...
        BarData mBarData = new BarData((IBarDataSet) getXAxisMonthValues(), mBarDataSet);
        ...
        BarData yBarData = new BarData((IBarDataSet) getXAxisYearValues(), yBarDataSet);
